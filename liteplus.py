...
def main(argv=sys.argv):
    ...
    LITE_PLUS_VERSION="SQLite*Plus:%s on %s Registered Functions: %i" % (sqlite3.sqlite_version, databaseName, registeredFunctions)
    ...
    while True:
        ...
        if ';' in l:
            ...
            if liteCmd=='.exit':
                ...
                sys.stdout.write("\n-- Dump generated by "+str(LITE_PLUS_VERSION)+"\n")
